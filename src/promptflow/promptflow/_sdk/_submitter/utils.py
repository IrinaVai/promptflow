...
class SubmitterHelper:
    ...
    def resolve_connections(
        ...
        if flow.language == FlowLanguage.CSharp:
            ...
            connection_names = CSharpExecutorProxy.get_used_connection_names(
                flow_file=flow.flow_dag_path, working_dir=flow.code
            )
        else:
            from promptflow.batch import PythonExecutorProxy

            connection_names = PythonExecutorProxy.get_used_connection_names(
